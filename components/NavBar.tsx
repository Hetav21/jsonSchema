...
export default function NavBar() {
    return (
        <main className="z-10 xl:rounded-xl pt-4 mx-auto" >
        ...
        <div className="w-full flex md:justify-between items-center ml-8 2xl:px-12 py-4">
            ...
            <div className="flex justify-end mr-8 w-full">
                ...
                <Link href="https://json-schema.org/learn/getting-started-step-by-step" className="hidden lg:block hover:underline font-semibold p-2 md:p-4 text-slate-600 hover:text-primary">Docs</Link>
